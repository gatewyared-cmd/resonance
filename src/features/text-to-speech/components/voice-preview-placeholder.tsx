import { AudioLines, BookOpen, Link, Sparkles, Volume2 } from "lucide-react";
    ...
    <div className="hidden flex-1 lg:flex h-full flex-col items-center justify-center gap-6 border-t">
      <div className="flex flex-col items-center gap-3">
        <div className="relative flex w-32 items-center justify-center">
          ...
          <div className="relative z-10 -rotate-full rounded-full bg-foreground p-4">
      ...
      <Button variant="outline" size="sm" asChild>
        <Link href="mailto:business@code withyared.com">
          <BookOpen />
          Don&apos;t know how?
        </Link>
      </Button>
