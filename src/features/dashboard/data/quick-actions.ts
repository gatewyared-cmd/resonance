...
export const quickActions: QuickAction[] = [
    ...
    },
    {
        ...
        href: "/text-to-speech?text=Hey everyone, welcome back to another episode of The Curious Mind - the podcast where we dig into the stories, science, and strange ideas that shape our world. I'm yoiur host, and today we have an incredible guest who's going to challenge everything you thought you knew.",
    },
    {
    ...
    },
    {
        ...
        href: "/text-to-speech?text=Introducing BrightBean Coffee - the smoothest roast you'll ever taste. Sourced form high-altitude farms, slow-roasted to perfection, and delivered fresh to your door every single week. Wake up to something extraordinary. Try BrighBean today and get your first bag free.",
    },
    {
        ...
        href: "/text-to-speech?text=The rain hammered against the windows as she turned to face him. You knew, didn't you? she whispered, her voice barely holding together. He stepped forward, jaw clenched. I did what I had to do. The silence between them was louder than the storm outside.",
    },
    {
