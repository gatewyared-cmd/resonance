...
-- CreateEnum
CREATE TYPE "VoiceCategory" AS ENUM ('AUDIOBOOK', 'CANVERSATIONAL', 'CUSTOMER_SERVICE', 'GENERAL', 'NARRATIVE', 'CHERACTERS', 'MEDITATION', 'NOTIVATIONAL', 'PODCAST', 'ADVERTISING', 'VOICEOVER', 'CORPORATE');
...
CREATE TABLE "Generation" (
    ...
    "r20bjectKey" TEXT,
    "tempurature" DOUBLE PRECISION NOT NULL,
